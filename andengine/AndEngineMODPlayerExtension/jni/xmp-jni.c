...
JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_init(JNIEnv *env,
                                                              jobject obj) {
...
JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_deinit(JNIEnv *env,
                                                                jobject obj) {
  xmp_close_audio(ctx);
  xmp_deinit(ctx);
  xmp_free_context(ctx);
...
JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_loadModule(
...
JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_testModule(
    JNIEnv *env, jobject obj, jstring name) {
  const char *filename;
  int res;
...
JNIEXPORT jshortArray JNICALL Java_org_helllabs_android_xmp_Xmp_getBuffer(
...
JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_nextOrd(JNIEnv *env,
                                                                 jobject obj) {
  return xmp_ord_next(ctx);
}

JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_prevOrd(JNIEnv *env,
                                                                 jobject obj) {
  return xmp_ord_prev(ctx);
}

JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_setOrd(JNIEnv *env,
                                                                jobject obj,
                                                                jint n) {
...
JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_incGvol(JNIEnv *env,
                                                                 jobject obj) {
  return xmp_gvol_inc(ctx);
}

JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_decGvol(JNIEnv *env,
                                                                 jobject obj) {
  return xmp_gvol_dec(ctx);
}

JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_seek(JNIEnv *env,
                                                              jobject obj,
                                                              jint time) {
  int i, t;
...
JNIEXPORT jobject JNICALL Java_org_helllabs_android_xmp_Xmp_getModInfo(
  ...
  modInfo = (*env)->NewObject(env, modInfoClass, cid, name, type, fname, mi.chn,
                              mi.pat, mi.ins, mi.trk, mi.smp, mi.len, mi.bpm,
                              mi.tpo, mi.time);

  return modInfo;
}

JNIEXPORT jint JNICALL Java_org_helllabs_android_xmp_Xmp_time(JNIEnv *env,
                                                              jobject obj) {
